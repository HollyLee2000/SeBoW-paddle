...
if __name__ == '__main__':
    ...
    best_prec1 = 0
    writer = SummaryWriter(os.path.join(args.checkpoint, 'logs_cifar100_forest_256_b'))
    logger = Logger(os.path.join(args.checkpoint, 'log_cifar100_forest_256_b.txt'), title='cifar10_tree')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        }, is_best, checkpoint=args.checkpoint, filename='checkpoint_cifar100_tree_forest_256_b.pth.tar',
            best_filename='model_best_cifar100_forest_256_b.pth.tar')
